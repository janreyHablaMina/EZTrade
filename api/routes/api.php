...
Route::get('/users/{id}/team', [UserController::class, 'team']);
...
Route::get('/messages/global', [\App\Http\Controllers\MessageController::class, 'getGlobalHistory']);
...
Route::post('/trading-codes/automated', [\App\Http\Controllers\TradingCodeController::class, 'generateAutomated']);
