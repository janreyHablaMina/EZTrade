        ...
        {items.map((item) => {
          ...
          return (
            <Link
              key={item.label}
              href={item.href}
              className="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm text-muted transition hover:bg-white/[0.04] hover:text-white"
            >
              <Icon className="h-4 w-4 shrink-0 text-purple-bright/80 group-hover:text-purple-bright" />
